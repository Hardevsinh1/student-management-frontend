        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-900">{profileData.dob ? formatDate(profileData.dob) : "-"}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500">
                Joining Date
              ...
              <p className="text-gray-900">
                {profileData.joiningDate ? formatDate(profileData.joiningDate) : "-"}
              </p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500">
              ...
              <p className="text-gray-900">
                {profileData.salary != null ? `₹${profileData.salary.toLocaleString()}` : "-"}
              </p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500">
